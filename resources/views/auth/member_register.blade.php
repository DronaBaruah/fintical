...
<body class="bg-gray-700">
    <div class="font-sans text-gray-900 antialiased">
        ...
        <div class="relative md:ml-64 bg-no-repeat bg-contain md:pt-5 pb-10"
            ...
            <div class="px-1 md:px-0 mt-5">
                <div class="bg-gray-100 text-gray-500 rounded-xl shadow-xl w-full overflow-hidden m-auto"
                    ...
                    <div class="md:flex w-full">
                        ...
                        <div class="w-full md:w-1/2 py-5 px-5 md:px-10">
                            <div class="text-center mb-10">
                                <h1 class="font-semibold text-xl text-gray-900">REGISTER MEMBER</h1>
                                <p>Enter information to register</p>
                            </div>

                            @if (session()->has('message'))
                            <div class="m-auto mb-10 md:w-4/5">
                                <p class="w-full my-4 text-center font-bold text-gray-800 bg-green-500 rounded-md py-3">
                                    {{ session()->get('message') }}
                                </p>
                            </div>
                            @endif
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="text" name="name" value="{{ old('name') }}"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 text-gray-900 border-gray-200 outline-none focus:border-indigo-500"
                                    ...
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="email" name="email" value="{{ old('email') }}"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg text-gray-900 border-2 border-gray-200 outline-none focus:border-indigo-500"
                                ...
                                <div class="flex -mx-3" id="share_no_div">
                                    <div class="w-full px-3 mb-5">
                                        <label for="" class="text-xs font-semibold px-1">No of Share Member Have</label>
                                        <div class="flex">
                                            <div
                                                class="w-10 z-0 pl-1 text-center pointer-events-none flex items-center justify-center">
                                                <i class="mdi mdi-account-outline text-gray-400 text-lg"></i>
                                            </div>
                                            <input type="number" name="share_no" id="share_no"
                                                value="{{ old('share_no') }}"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg text-gray-900 border-2 border-gray-200 outline-none focus:border-indigo-500"
                                                placeholder="No of Share Member Have" required autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="flex -mx-3">
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-3 mb-5">
                                        <button
                                            class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">{{ __('Register Member') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div class="md:ml-64 bg-gray-700 flex items-center justify-center pb-5">
            <div class="scrollbar bg-white mx-auto w-full rounded" style="max-width:1000px;" id="style-7">
                <div class="flex items-center justify-center font-sans">
                    <div class="w-full">
                        <div class="bg-white shadow-md rounded">
                            <table class="min-w-max w-full table-auto">
                                <thead>
                                    <tr class="bg-gray-200 text-gray-800 text-sm leading-normal">
                                        <th class="py-2 px-4 text-center">#</th>
                                        <th class="py-2 px-4 text-center">Member Name</th>
                                        <th class="py-2 px-4 text-center">Address</th>
                                        <th class="py-2 px-4 text-center">Phone No.</th>
                                        <th class="py-2 px-4 text-center">Action</th>
                                    </tr>
                                </thead>
                                <tbody class="text-gray-800 font-normal bg-white ">
                                    <?php $number = 1; ?>
