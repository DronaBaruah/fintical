    ...
    <div class="flex items-center justify-center px-5 py-2">
        <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1100px">
            <div class="md:flex w-full">
                ...
                <div class="w-full md:w-3/5 py-5 px-5 md:px-10">
                    <div class="text-center mb-10">
                        <h1 class="font-semibold text-2xl text-gray-900">ADMIN REGISTER</h1>
                        ...
                        <div>
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Society Id</label>
                                    <div class="flex">
                                        <div
                                            class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                        </div>
                                        <input type="text" name="society_id" value="{{ session()->get('society_id') }}"
                                            class="w-full -ml-10  pr-3 py-2 rounded-lg border-2 font-semibold text-black border-gray-200 outline-none bg-gray-100"
                                            required readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Society Name</label>
                                    <div class="flex">
                                        <div
                                            class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                        </div>
                                        <textarea name="society_name" id="society_name"
                                            class="w-full -ml-10  pr-3 py-2 rounded-lg border-2 font-semibold text-black border-gray-200 outline-none bg-gray-100"
                                            required readonly>{{ session()->get('society_name') }}</textarea>
                            ...
                            $('document').ready(function() {
                                $("#society_member").change(function() {
                                    var data = $(this).val();
                                    if (data == "no") {
                                        $('#share_no_div').hide();
                                    } else {
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Are You a Member of the
                                        Society</label>
                                    <div class="flex">
                                        <div
                                            class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                        ...
                                        <select name="society_member" id="society_member"
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                            required>
                            ...
                            <div class="flex -mx-3" id="share_no_div">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">No of Share You Have</label>
                                    <div class="flex">
                                        <div
                                            class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            <i class="mdi mdi-account-outline text-gray-400 text-lg"></i>
                                        </div>
                                        <input type="number" name="share_no" id="share_no" value="{{ old('share_no') }}"
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                            placeholder="No of Share You Have" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <button
                                        class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">{{ __('Register') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
