        ...
        <div class="md:ml-64 min-h-screen pt-5 pb-10 px-1">
            ...
            <div class="bg-gray-100 text-gray-500 rounded-md shadow-xl w-full overflow-hidden m-auto md:mt-5"
                ...
                <div class="md:flex w-full m-auto">
                    <div class="w-full py-5 px-4 md:px-10">
                        <div class="text-center mb-5">
                            <h1 class="font-semibold text-xl text-gray-900 uppercase">Reports</h1>
                        </div>
                                    ...
                                    <tbody class="text-gray-600 text-sm font-light">
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/reports/collection_report" target="_blank">
                                                    @csrf
                                                    <?php 
                                                    ...
                                                    <button class="flex items-center justify-start">
                                                        <span class="font-medium">Collection Report</span>
                                                    </button>
                                            </td>
                                            <td class="py-3 px-2 text-center">
                                                <div class="flex items-center justify-center">
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/reports/deposit_report" target="_blank">
                                                    @csrf
                                                    <?php 
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/reports/late_fine_report" target="_blank">
                                                    @csrf
                                                    <?php 
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/reports/loan_report" target="_blank">
                                                    @csrf
                                                    <?php 
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/reports/interest_report" target="_blank">
                                                    @csrf
                                                    <?php 
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/reports/interest_late_fine_report"
                                                    target="_blank">
                                                    @csrf
                                                    <?php 
                                                    ...
                                                    ?>
                                                    <button class="flex items-center justify-start">
                                                        <span class="font-medium">Fine on Interest Non Payment
                                                            Report</span>
                                                    </button>
                                            </td>
                                            <td class="py-3 px-2 text-center">
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/reports/loan_repayment_report"
                                                    target="_blank">
                                                    @csrf
                                                    <?php 
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/reports/expenditure_report" target="_blank">
                                                    @csrf
                                                    <?php 
                                                    ...
                                                    ?>
                                                    <button class="flex items-center justify-start">
                                                        <span class="font-medium">Expenditure
                                                            Report</span>
                                                    </button>
                                            </td>
                                            <td class="py-3 px-2 text-center">
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/reports/cash_in_hand_report"
                                                    target="_blank">
                                                    @csrf
                                                    <?php 
                                                    ...
                                                    ?>
                                                    <button class="flex items-center justify-start">
                                                        <span class="font-medium">Cash in Hand
                                                            Report</span>
                                                    </button>
                                            </td>
                                            <td class="py-3 px-2 text-center">
