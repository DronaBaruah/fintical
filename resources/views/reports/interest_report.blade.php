...
<head>
    <meta name=Title content="Interest Report">
        ...
        <tbody>
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <thead>
                    ...
                    <tr height=24>
                        ...
                        <th height=24 width="40%" class="xl113 text-center" style='height:18.0pt'>Member
                            Name</th>
                        <th height=24 width="15%" class="xl113 text-center" style='height:18.0pt'>Date</th>
                        <th width="20%" class="xl113 text-right pr-4">Interest Amount</th>
                    </tr>
                </thead>
                <tbody>
                    <?php $number = 1; ?>
                    ...
                    <tr height=24 class="odd">
                        ...
                        <td width="40%" height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ $interest->user->name }}
                        </td>
                        <td width="15%" height=24 class="xl123 text-center" style='height:18.0pt'>
            ...
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <tr height=24 style='mso-height-source:userset;height:18.0pt'>
                    ...
                    <td class="xl101 font-bold text-center" style='border-left:none'>Total Interest</td>
                ...
                <tr height=24>
                    <td colspan=12 height=24 class=xl172>Tel:
                        0-000-000-0000 Fax: 0-000-000-0000 E-mail: service@fintical.com Web:
                        www.fintical.com</td>
                </tr>
                <tr height=24>
