...
<head>
    <meta name=Title content="Late Fine Report">
        ...
        <tbody>
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <thead>
                    ...
                    <tr height=24>
                        ...
                        <th height=24 width="15%" class="xl113 text-center" style='height:18.0pt'>Month</th>
                        <th width="20%" class="xl113 text-right pr-4">Late Fine Amount (₹)</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr height=24 class="odd">
                        <td width="5%" height=24 class="xl123 text-center" style='height:18.0pt'>{{ $number }}</td>
                        <td width="15%" height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ $late_fine->deposit_id }}
                        </td>
                        ...
                        <td width="20%" class="xl123 text-right pr-4">
                            {{ number_format((float)$late_fine->fine, 2, '.', '') }}/-
                        </td>
                    </tr>
                    <?php $number ++ ?>
                    @endforeach
            ...
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <tr height=24>
                    ...
                    <td class="xl101 font-bold text-center" style='border-left:none'>Total Fine Amount</td>
