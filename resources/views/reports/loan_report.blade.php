...
<head>
    <meta name=Title content="Loan Report">
        ...
        <tbody>
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <thead>
                    ...
                    <tr height=24>
                        ...
                        <th height=24 width="20%" class="xl113 text-center" style='height:18.0pt'>
                            Transaction ID
                        </th>
                        <th height=24 width="35%" class="xl113 text-center" style='height:18.0pt'>Member
                            Name</th>
                        <th height=24 width="20%" class="xl113 text-center" style='height:18.0pt'>Date</th>
                        <th width="20%" class="xl113 text-right pr-4">Loan Amount</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr height=24 class="odd">
                        ...
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'>{{ $loan->loan_id }}
                        </td>
                        <td width="35%" height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ $loan->user->name }}</td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ date('jS M Y', strtotime($loan->date)) }}</td>
            ...
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <tr height=24>
                    ...
                    <td class="xl101 font-bold text-center" style='border-left:none'>Total Loan Amount</td>
                    <td class="xl102 font-bold">₹</td>
                    <td class="xl103 font-bold pr-4"><span style='mso-spacerun:yes'> </span>{{ $total_loan_amount }}/-
                    </td>
                </tr>
                <tr height=24>
