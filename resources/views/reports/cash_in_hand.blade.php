...
<head>
    <meta name=Title content="Cash in Hand Report">
    ...
    <table>
        <tbody>
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <tbody width="100%">
                    <tr height=24>
                        <td width="10%" height=24 class="xl123 text-center" style='height:18.0pt'>1</td>
                        <td width="30%" height=24 class="xl123 text-center" style='height:18.0pt'>Deposit Collection
                        </td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'>Debit (+)</td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'></td>
                        <td width="20%" class="xl123 text-right pr-4">
                            {{ number_format((float)$total_deposit_amount, 2, '.', '') }}/-</td>
                    </tr>
                    <tr height=24 class="bg-gray-200">
                        <td width="10%" height=24 class="xl123 text-center" style='height:18.0pt'>2</td>
                        <td width="30%" height=24 class="xl123 text-center" style='height:18.0pt'>Late Fine</td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'>Debit (+)</td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'></td>
                        <td width="20%" class="xl123 text-right pr-4">
                            {{ number_format((float)$total_late_fine_amount, 2, '.', '') }}/-</td>
                    </tr>
                    <tr height=24>
                        <td width="10%" height=24 class="xl123 text-center" style='height:18.0pt'>3</td>
                        <td width="30%" height=24 class="xl123 text-center" style='height:18.0pt'>Interest Collection
                        </td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'>Debit (+)</td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'></td>
                        <td width="20%" class="xl123 text-right pr-4">
                    ...
                    <tr height=24 class="bg-gray-200">
                        <td width="10%" height=24 class="xl123 text-center" style='height:18.0pt'>4</td>
                        <td width="30%" height=24 class="xl123 text-center" style='height:18.0pt'>Previous Interest Due
                        </td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'>Debit (+)</td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'></td>
                        <td width="20%" class="xl123 text-right pr-4">
                            {{ number_format((float)$total_pre_interest_amount, 2, '.', '') }}/-</td>
                    </tr>
                    <tr height=24>
                        <td width="10%" height=24 class="xl123 text-center" style='height:18.0pt'>5</td>
                        <td width="30%" height=24 class="xl123 text-center" style='height:18.0pt'>Fine on Interest Non
                            Payment
                        </td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'>Debit (+)</td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'></td>
                    ...
                    <tr height=24 class="bg-gray-200">
                        <td width="10%" height=24 class="xl123 text-center" style='height:18.0pt'>6</td>
                        <td width="30%" height=24 class="xl123 text-center" style='height:18.0pt'>Loan Repayment</td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'>Debit (+)</td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'></td>
                        <td width="20%" class="xl123 text-right pr-4">
                    ...
                    <tr height=24>
                        <td width="10%" height=24 class="xl123 text-center" style='height:18.0pt'>7</td>
                        <td width="30%" height=24 class="xl123 text-center" style='height:18.0pt'>Loan Given</td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'></td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'>Credit (-)</td>
                        <td width="20%" class="xl123 text-right pr-4">
                            {{ number_format((float)$total_loan_amount, 2, '.', '') }}/-
                        </td>
                    </tr>
                    <tr height=24 class="bg-gray-200">
                        <td width="10%" height=24 class="xl123 text-center" style='height:18.0pt'>8</td>
                        <td width="30%" height=24 class="xl123 text-center" style='height:18.0pt'>Expenditure</td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'></td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'>Credit (-)</td>
                        <td width="20%" class="xl123 text-right pr-4">
                            {{ number_format((float)$total_expenditure_amount, 2, '.', '') }}/-
                        </td>
                    </tr>
            ...
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <tr height=24>
                    ...
                    <td class="xl101 font-bold text-center" style='border-left:none'>Total Cash in Hand</td>
                    <td class="xl102 font-bold">₹</td>
                    <td class="xl103 font-bold pr-4"><span style='mso-spacerun:yes'> </span>{{ $total_cash_in_hand }}/-
                    </td>
                </tr>
                <tr height=24>
