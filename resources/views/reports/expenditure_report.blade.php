...
<head>
    <meta name=Title content="Expenditure Report">
        ...
        <tbody>
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <thead>
                    ...
                    <tr height=24>
                        ...
                        <th height=24 width="40%" class="xl113 text-center" style='height:18.0pt'>Remark
                        </th>
                        <th width="20%" class="xl113 text-right pr-4">Expenditure Amount</th>
                    </tr>
                </thead>
            ...
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <tr height=24>
                    ...
                    <td class="xl101 font-bold text-center" style='border-left:none'>Total Expenditure</td>
                    <td class="xl102 font-bold">₹</td>
                    <td class="xl103 font-bold pr-4"><span
                            style='mso-spacerun:yes'> </span>{{ $total_expenditure_amount }}/-
                    </td>
                </tr>
                <tr height=24>
