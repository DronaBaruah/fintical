            ...
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <thead>
                    ...
                    <tr height=24>
                        ...
                        <th height=24 width="27%" class="xl113 text-center" style='height:18.0pt'>Member
                            Name</th>
                        <th height=24 width="15%" class="xl113 text-center" style='height:18.0pt'>Date
                        </th>
                        <th height=24 width="12%" class="xl113 text-center" style='height:18.0pt'>Month
                        </th>
                        <th width="10%" class="xl113 text-center">Share No.</th>
                        <th width="18%" class="xl113 text-right pr-4">Total Share Value</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr height=24 class="odd">
                        <td height=24 width="5%" class="xl123 text-center" style='height:18.0pt'>{{ $number }}</td>
                        <td height=24 width="13%" class="xl123 text-center" style='height:18.0pt'>
                            {{ $deposit->deposit_id }}
                        </td>
                        <td height=24 width="27%" class="xl123 text-center" style='height:18.0pt'>
                            {{ $deposit->user->name }}
                        </td>
                        <td height=24 width="15%" class="xl123 text-center" style='height:18.0pt'>
                            {{ date('jS M Y', strtotime($deposit->date)) }}</td>
                        <td height=24 width="12%" class="xl123 text-center" style='height:18.0pt'>
                            {{ $deposit->month }}</td>
                        <td width="10%" class="xl123 text-center">{{ $deposit->user->share_no }}</td>
                        <td width="18%" class="xl123 text-right pr-4">
                    ...
                    @if($deposits->isEmpty())
                    <tr height=24 class="odd">
                        <td colspan=7 height=24 class="xl123 text-center text-red-700 font-semibold"
                            style='height:18.0pt'>
                            No Record Found ... !</td>
                    </tr>
                    @endif
