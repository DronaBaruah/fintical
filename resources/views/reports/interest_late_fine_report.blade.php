...
<head>
    <meta name=Title content="Late Fine on Interest Report">
    <meta name=Keywords content="">
    <meta http-equiv=Content-Type content="text/html; charset=utf-8">
    <link rel="stylesheet" href="{{ asset('css/app.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom.css') }}">

    <title>Late Fine on Interest Report</title>
</head>
        ...
        <tbody>
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <thead>
                    ...
                    <tr height=24>
                        ...
                        <th height=24 width="15%" class="xl113 text-center" style='height:18.0pt'>
                            Transaction ID
                        </th>
                        <th height=24 width="30%" class="xl113 text-center" style='height:18.0pt'>Member
                            Name</th>
                        <th height=24 width="20%" class="xl113 text-center" style='height:18.0pt'>Date</th>
                        <th width="25%" class="xl113 text-right pr-4">Late Fine on Interest Amount</th>
                    </tr>
                ...
                <tbody>
                    ...
                    <?php $number = 1; ?>
                    @foreach ($interest_late_fines as $interest_late_fine)
                    <tr height=24 class="odd">
                        <td width="10%" height=24 class="xl123 text-center" style='height:18.0pt'>{{ $number }}</td>
                        <td width="15%" height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ $interest_late_fine->interest_id }}</td>
                        <td width="30%" height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ $interest_late_fine->user->name }}</td>
                        <td width="20%" height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ date('jS M Y', strtotime($interest_late_fine->date)) }}</td>
                        <td width="25%" class="xl123 text-right pr-4">
                            {{ number_format((float)$interest_late_fine->lif_amount, 2, '.', '') }}/-
                        </td>
                    </tr>
                    <?php $number ++ ?>
                    @endforeach

                    @if($interest_late_fines->isEmpty())
                    <tr height=24 class="odd">
            ...
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <tr height=24>
                    ...
                    <td class="xl101 font-bold text-center" style='border-left:none'>Total Late Fine on Interest
                    </td>
                    <td class="xl102 font-bold">₹</td>
                    <td class="xl103 font-bold pr-4"><span
                            style='mso-spacerun:yes'> </span>{{ $total_interest_late_fine_amount }}/-
                    </td>
                </tr>
                <tr height=24>
