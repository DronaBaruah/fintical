        ...
        <tbody>
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <thead>
                    ...
                    <tr height=24>
                        ...
                        <th height=24 width="35%" class="xl113 text-center" style='height:18.0pt'>Member
                            Name</th>
                        <th height=24 width="18%" class="xl113 text-center" style='height:18.0pt'>Date</th>
                        <th width="22%" class="xl113 text-right pr-4">Repayment Amount</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr height=24 style='mso-height-source:userset;height:18.0pt' class="odd">
                        ...
                        <td width="15%" height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ $disburse->disburse_id }}
                        </td>
                        <td width="35%" height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ $disburse->user->name }}
                        </td>
                        <td width="18%" height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ date('jS M Y', strtotime($disburse->date)) }}</td>
                        <td width="22%" class="xl123 text-right pr-4">{{ $disburse->amount }}/-</td>
                    </tr>
                    <?php $number ++ ?>
                    @endforeach
