                ...
                <div class="md:flex w-full m-auto">
                    ...
                    <div class="w-full py-5 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-semibold text-xl text-gray-900 uppercase">LOAN Repayment</h1>
                        </div>
                            ...
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <div
                                        ...
                                        {{ date('d-m-Y', strtotime($disburse->date)) }}
                                    </div>
                                </div>
                            </div>
                            <div class="w-full px-3 mb-5">
                                <label for="" class="text-xs font-semibold px-1">Loan Repayment
                                    Amount</label>
                                <div class="flex">
                                    <div
                                        class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            ...
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <textarea name="remark"
                                        class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 font-semibold text-black border-gray-200 outline-none bg-gray-100"
                                        readonly> {{ $disburse->remark }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="md:flex -mx-3">
                            ...
                            <div class="w-full px-2 mb-3 md:mt-2 mt-5">
                                <form action="/loan_repayment/delete/{{ $disburse->id }}" method="POST"
                                    class="hide-submit"
                        ...
                        <div class="bg-white shadow-md rounded">
                            <table class="min-w-max w-full table-auto">
                                ...
                                <tbody class="text-gray-800 text-sm bg-white">
                                    <?php $number = 1 ; ?>
                                    @foreach ($disburse_data as $disburse)
