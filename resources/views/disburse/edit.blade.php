                ...
                <div class="md:flex w-full m-auto">
                    ...
                    <div class="w-full py-5 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-semibold text-xl text-gray-900 uppercase">update LOAN Repayment</h1>
                            <p>Enter Loan Repayment Information</p>
                        </div>
                        ...
                        <form method="POST" action="/loan_repayment/{{ $disburse->id }}">
                            @csrf
                            @method('PUT')
                            <div>
                                ...
                                <div class="md:flex -mx-3">
                                    ...
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="date" name="date" id="date" value="{{ $disburse->date }}"
                                    ...
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="number" name="amount" placeholder="Enter Repayment Loan Amount"
                                                max="{{ $disburse->amount + $total_due_amount }}" min='0'
                                    ...
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <textarea name="remark"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500">{{ $disburse->remark }}</textarea>
                                        </div>
                                    </div>
                                </div>
