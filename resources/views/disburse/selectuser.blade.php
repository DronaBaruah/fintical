                ...
                <div class="md:flex w-full m-auto">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-xl text-gray-900 uppercase">Loan Repayment</h1>

                        </div>

                        @if (session()->has('message'))
                        <div class="mb-10 bg-green-100 border border-green-400 text-gray-800 px-4 py-3 rounded-md relative interestModal"
                        ...
                        <form method="GET" action="/loan_repayment/create">
                            @csrf
                            <div>
                                <div class="flex -mx-3">
                            ...
                            <table class="min-w-max w-full table-auto">
                                ...
                                <tbody class="text-gray-800 text-sm bg-white">
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-100 text-sm">
                                        ...
                                        <td class="py-2 px-4 text-center whitespace-nowrap">
                                            <div class="flex items-center justify-center">
                                                <span>{{ $disburse->disburse_id }}</span>
                                            </div>
                                        </td>
                                        <td class="py-2 px-4 text-center whitespace-nowrap">
                                            <div class="flex items-center justify-center">
                                                <span>{{ $disburse->user->name }}</span>
                                            </div>
                                        </td>
                                        <td class="py-2 px-4 text-center">
                                            <div class="flex items-center justify-center">
                                                <span>{{ date('jS M Y', strtotime($disburse->date)) }}</span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="py-2 px-4 text-center">
                                            <div class="flex item-center justify-center">
                                                <div class="w-5 mr-5 transform hover:text-purple-500 hover:scale-110">
                                                    <a href="/loan_repayment/{{ $disburse->id }}">
                                                ...
                                                <div class="w-5 mr-5 transform hover:text-purple-500 hover:scale-110">
                                                    <a href="/loan_repayment/{{ $disburse->id }}/edit">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"
                                                ...
                                                <div class="w-5 transform hover:text-purple-500 hover:scale-110">
                                                    <form action="/loan_repayment/delete/{{ $disburse->id }}"
