                ...
                <div class="md:flex w-full m-auto">
                    <div class="w-full py-5 px-5 md:px-10">
                        <div class="text-center mb-5">
                            <h1 class="font-semibold text-xl text-gray-900 uppercase">My Reports</h1>
                        </div>
                                    ...
                                    <tbody class="text-gray-600 text-sm font-light">
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/my_reports/deposit_report" target="_blank">
                                                    @csrf
                                                    <?php 
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/my_reports/late_fine_report"
                                                    target="_blank">
                                                    @csrf
                                                    <?php 
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/my_reports/loan_report" target="_blank">
                                                    @csrf
                                                    <?php 
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/my_reports/interest_report" target="_blank">
                                                    @csrf
                                                    <?php 
                                                    ...
                                                    ?>
                                                    <button class="flex items-center justify-start">
                                                        <span class="font-medium">Total Interest
                                                            Report</span>
                                                    </button>
                                            </td>
                                            <td class="py-3 px-2 text-center">
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-indigo-100">
                                            ...
                                            <td class="py-3 px-2 text-center">
                                                <form method="GET" action="/my_reports/loan_repayment_report"
                                                    target="_blank">
                                                    @csrf
                                                    <?php 
