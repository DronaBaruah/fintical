            ...
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <thead>
                    <tr>
                        <th colspan="100%">
                            <table width="100%">
                                ...
                                <tr height=24>
                                    <td height=24 class="xl175 text-center font-semibold" style='height:18.0pt'>Loan
                                        Report
                                    </td>
                    ...
                    <tr height=24 style='mso-height-source:userset;height:18.0pt'>
                        ...
                        <th width="20%" class="xl113 text-right pr-4">Total loan Amount</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr height=24 style='mso-height-source:userset;height:18.0pt' class="odd">
                        ...
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>{{ $loan->loan_id }}</td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ date('jS M Y', strtotime($loan->date)) }}</td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>{{ $loan->remark }}</td>
                        <td class="xl123 text-right pr-4">{{ number_format((float)$loan->amount, 2, '.', '') }}/-
                        </td>
                    </tr>
                    <?php $number ++ ?>
                    @endforeach
