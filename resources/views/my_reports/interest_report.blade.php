...
<head>
    <meta name=Title content="Deposit Report">
    <meta name=Keywords content="">
    <meta http-equiv=Content-Type content="text/html; charset=utf-8">
    <link rel="stylesheet" href="{{ asset('css/app.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom.css') }}">

    <title>Total Interest Report</title>
        ...
        <tbody>
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <thead>
                    <tr>
                        <th colspan="100%">
                            <table width="100%">
                                ...
                                <tr height=24>
                                    <td height=24 class="xl175 text-center font-semibold" style='height:18.0pt'>Total
                                        Interest
                                    </td>
                    ...
                    <tr height=24>
                        ...
                        <th height=24 width="13%" class="xl113 text-center" style='height:18.0pt'>Transaction ID
                        </th>
                        <th height=24 width="13%" class="xl113 text-center" style='height:18.0pt'>Date</th>
                        <th height=24 width="12%" class="xl113 text-center" style='height:18.0pt'>Previous Int.</th>
                        <th height=24 width="12%" class="xl113 text-center" style='height:18.0pt'>Current Int.</th>
                        <th height=24 width="12%" class="xl113 text-center" style='height:18.0pt'>Late Fine Int.
                        </th>
                        <th height=24 width="20%" class="xl113 text-center" style='height:18.0pt'>Remark</th>
                        <th width="13%" class="xl113 text-right pr-4">Total Interest</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr height=24 class="odd">
                        ...
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>{{ $interest->interest_id }}/-
                        </td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ date('jS M Y', strtotime($interest->date)) }}</td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ $interest->previous_interest }}/-</td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ $interest->interest_amount }}/-</td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>{{ $interest->lif_amount }}/-
                        </td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>{{ $interest->remark }}</td>
                        <td class="xl123 text-right pr-4">
                            {{ number_format((float)$interest->total_interest, 2, '.', '') }}/-</td>
                    </tr>
                    <?php $number ++ ?>
                    @endforeach
                    ...
                    <tr height=24 class="odd">
                        <td colspan=8 height=24 class="xl123 text-center text-red-700 font-semibold"
            ...
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <tr height=24>
                    ...
                    <td class="xl101 font-bold text-center" style='border-left:none'>Total Interest Amount</td>
                    <td class="xl102 font-bold">₹</td>
                    <td class="xl103 font-bold pr-4"><span
                            style='mso-spacerun:yes'> </span>{{ $total_interest_amount }}/-
                    </td>
                </tr>
                <tr height=24>
