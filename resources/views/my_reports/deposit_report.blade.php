        ...
        <tbody>
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <thead>
                    <tr>
                        <th colspan="100%">
                            <table width="100%">
                                ...
                                <tr height=24>
                                    <td height=24 class="xl175 text-center font-semibold" style='height:18.0pt'>Deposit
                                        Report
                                    </td>
                    ...
                    <tr height=24>
                        <th height=24 width="7%" class="xl113 text-center" style='height:18.0pt'>#</th>
                        <th height=24 width="13%" class="xl113 text-center" style='height:18.0pt'>
                            Transaction ID
                        </th>
                        <th height=24 width="12%" class="xl113 text-center" style='height:18.0pt'>Date</th>
                        <th height=24 width="13%" class="xl113 text-center" style='height:18.0pt'>Month</th>
                        <th height=24 width="35%" class="xl113 text-center" style='height:18.0pt'>Remark
                        </th>
                        <th width="20%" class="xl113 text-right pr-4">Total Deposit Amount</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr height=24 class="odd" colspan="100%">
                        <td width="7%" height=24 class="xl123 text-center" style='height:18.0pt'>{{ $number }}</td>
                        <td width="13%" height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ $deposit->deposit_id }}
                        </td>
                        <td width="12%" height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ date('jS M Y', strtotime($deposit->date)) }}</td>
                        <td width="13%" height=24 class="xl123 text-center" style='height:18.0pt'>{{ $deposit->month }}
                        </td>
                        <td width="35%" height=24 class="xl123 text-center" style='height:18.0pt'>{{ $deposit->remark }}
                        </td>
                    ...
                    <tr height=24 class="odd">
                        <td colspan=6 height=24 class="xl123 text-center text-red-700 font-semibold"
                            style='height:18.0pt'>No Record Found ... !</td>
                    </tr>
                    @endif
            ...
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <tr height=24>
                    ...
                    <td class="xl101 font-bold text-center" style='border-left:none'>Total Deposit Amount</td>
                    <td class="xl102 font-bold">₹</td>
                    <td class="xl103 font-bold pr-4"><span
                            style='mso-spacerun:yes'> </span>{{ $total_deposit_amount }}/-
                    </td>
                </tr>
                <tr height=24>
