            ...
            <div class="px-1 md:px-0">
                ...
                <div class="bg-gray-100 mx-auto text-gray-500 rounded-b shadow-xl w-full overflow-hidden"
                    ...
                    <div class="text-center my-5">
                        <h1 class="font-bold md:text-xl text-xl text-gray-900">MEMBER DETAILS</h1>
                    </div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <div
                                        class="w-full -ml-10 pl-3 pr-3 py-2 capitalize rounded-lg border-2 font-semibold text-gray-900 border-gray-200 outline-none bg-gray-100">
                                        {{ $society_data->name }}
                                    </div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <div
                                        class="w-full -ml-10 pl-10 pr-3 py-2 capitalize rounded-lg border-2 font-semibold text-gray-900 border-gray-200 outline-none bg-gray-100">
                                        {{ $user->name }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <div
                                        class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 font-semibold text-gray-900 border-gray-200 outline-none bg-gray-100">
                                        {{ $society_data->share_value * $user->share_no }}/-
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="w-full flex justify-center">
                        <div class="my-5 pr-4">
                            <a href="/members/{{ $user->id }}/edit">
                                <button
                                    class="block mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-5 py-3 font-semibold uppercase">Edit
                                    Member</button>
                            </a>
                        </div>
                        @if(Auth::user()->id != $user->id)
                        <div class="my-5">
                            <form action="/members/delete/{{ $user->id }}" method="POST"
                                onsubmit="return confirm('Do you really want to delete member?');">
                                @csrf
                                @method('PUT')
                                <button type="submit"
                                    class="block mx-auto bg-red-500 hover:bg-gray-700 focus:bg-gray-700 text-white rounded-lg px-5 py-3 font-semibold uppercase">{{ __('Delete Member') }}
                                </button>
                            </form>
                        </div>
                        @endif
