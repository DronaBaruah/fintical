                ...
                <div class="md:flex w-full">
                    <div class="w-full py-5 px-5 md:px-10">
                        <div class="text-center mb-5">
                            <h1 class="font-semibold text-xl text-gray-900">UPDATE DEPOSIT FORM</h1>
                        ...
                        <form method="POST" action="/deposit/{{ $deposit->id }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div>
                                ...
                                <h1 class="font-semibold text-xl text-center text-gray-900 py-3">Transaction Id: <span
                                        class="text-red-700">{{ $deposit->deposit_id }}</span></h1>
                                <div class="md:flex -mx-3">
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <select name="month" id=""
                                                ...
                                                required autofocus>
                                                <option value="{{ $deposit->month }}">{{ $deposit->month }}</option>
                                ...
                                <div class="md:flex -mx-3">
                                    ...
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="number" name="fine" min="0" placeholder="0" step=".01"
                                                value="{{ $deposit->fine }}"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500">
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <textarea name="remark"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500">{{ $deposit->remark }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-2 mb-3 mt-2">
                                        <button type="submit"
                                            class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-2 py-3 font-semibold">UPDATE
                                            DEPOSIT</button>
                                    </div>
                                </div>
                            </div>
