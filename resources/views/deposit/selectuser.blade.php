                ...
                <div class="md:flex w-full m-auto">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-xl text-gray-900 uppercase">Deposit</h1>
                        </div>
                        ...
                        <form method="GET" action="/deposit/create">
                            @csrf
                            <div>
                                <div class="flex -mx-3">
                                ...
                                <div class="flex -mx-3 md:pb-0 pb-28">
                                    <div class="w-full px-3 mb-5">
                                        <button type="submit"
                                            class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Next</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <table class="min-w-max w-full table-auto">
                                ...
                                <tbody class="text-gray-700 text-sm bg-white ">
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-100 text-sm">
                                        ...
                                        <td class="py-2 px-4 text-center">
                                            <div class="flex items-center justify-center">
                                                <span>₹ {{ $deposit->user->share_no * $society->share_value  }}</span>
                                            </div>
                                        </td>
                                        <td class="py-2 px-4 text-center">
                                            <div class="flex items-center justify-center">
