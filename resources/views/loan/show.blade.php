                ...
                <div class="md:flex w-full m-auto">
                    ...
                    <div class="w-full py-5 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-semibold text-xl text-gray-900 uppercase">Issue LOAN </h1>
                        </div>
                        ...
                        <div class="md:flex -mx-3">
                            ...
                            <div class="w-full px-3 mb-5">
                                <label for="" class="text-xs font-semibold px-1">Loan Amount</label>
                                <div class="flex">
                                    <div
                                        class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                        ...
                        <div class="md:flex -mx-3">
                            <div class="w-full px-2 mb-3 mt-2">
                                <a href="/loan/{{ $loan->id }}/edit">
                                    <button
                                        class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700  text-white rounded-lg px-2 py-3 font-semibold uppercase">EDIT
                                        loan</button>
                                </a>
                            </div>
                            <div class="w-full px-2 mb-3 md:mt-2 mt-5">
                                <form action="/loan/delete/{{ $loan->id }}" method="POST" class="hide-submit"
