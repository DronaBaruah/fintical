                ...
                <div class="md:flex w-full m-auto">
                    ...
                    <div class="w-full py-5 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-semibold text-xl text-gray-900 uppercase">Issue LOAN FORM</h1>
                            ...
                            <div>
                                ...
                                <div class="md:flex -mx-3">
                                    ...
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="number" name="amount" placeholder="Enter Loan Amount"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                                required autofocus>
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-2 mb-3 mt-2">
                                        <button
                                            class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-2 py-3 font-semibold text-xl">ISSUE
                                            LOAN</button>
                                    </div>
                                </div>
                            </div>
