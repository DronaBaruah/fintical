...
<body class="bg-gray-700">
    <div class="font-sans text-gray-900 antialiased">
        ...
        <div class="md:ml-64 pt-5 pb-10 px-1">
                ...
                <div class="md:flex w-full m-auto">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-xl text-gray-900 uppercase">Issue Loan</h1>
                        </div>
                        ...
                        <form method="GET" action="/loan/create">
                            @csrf
                            <div>
                                <div class="flex -mx-3">
                                ...
                                <tbody class="text-gray-800 text-sm bg-white">
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-100 text-sm">
                                        ...
                                        <td class="py-2 px-4 text-center">
                                            <div class="flex items-center justify-center">
                                                <span class="font-normal">{{ $loan->loan_id  }}</span>
                                            </div>
                                        </td>
                                        <td class="py-2 px-4 text-center whitespace-nowrap">
                                            <div class="flex items-center justify-center">
                                                <span class="font-normal">{{ $loan->user->name }}</span>
                                            </div>
                                        </td>
                                        <td class="py-2 px-4 text-center">
                                            <div class="flex items-center justify-center">
                                                <span
                                                    class="font-normal">{{ date('jS M Y', strtotime($loan->date)) }}</span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="py-2 px-4 text-center">
                                            <div class="flex item-center justify-center">
                                                ...
                                                <div class="w-5 transform hover:text-purple-500 hover:scale-110">
                                                    <form action="/loan/delete/{{ $loan->id }}" method="POST"
                                                        class="hide-submit"
