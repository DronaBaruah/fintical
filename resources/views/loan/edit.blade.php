                ...
                <div class="md:flex w-full m-auto">
                    ...
                    <div class="w-full py-5 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-semibold text-xl text-gray-900 uppercase">Update Issue LOAN</h1>
                        ...
                        <form method="POST" action="/loan/{{ $loan->id }}">
                            ...
                            <div>
                                ...
                                <div class="md:flex -mx-3">
                                    <div class="w-full px-3 mb-5">
                                        <label for="" class="text-xs font-semibold px-1">Previous Loan (₹)</label>
                                        <div class="flex">
                                            <div
                                                class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            </div>
                                            <div
                                                class="w-full -ml-10 pl-3  pr-3 py-2 rounded-lg border-2 font-bold text-red-500 border-gray-200 outline-none bg-gray-100">
                                                ₹ {{ $total_due_amount}}/-
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="md:flex -mx-3">
                                    ...
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="date" name="date" id="date" value="{{ $loan->date }}"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                                required autofocus>
                                        </div>
                                    </div>
                                    <div class="w-full px-3 mb-5">
                                        <label for="" class="text-xs font-semibold px-1">Enter Loan Amount</label>
                                        <div class="flex">
                                            <div
                                                class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                                <i class="mdi mdi-currency-inr text-gray-400 text-lg"></i>
                                            </div>
                                            <input type="number" name="amount" placeholder="Enter Loan Amount" min="0"
                                                value="{{ $loan->amount }}"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                                required>
                                        </div>
                                    ...
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <textarea name="remark"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500">{{ $loan->remark }}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-2 mb-3 mt-2">
                                        <button type="submit"
                                            class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-2 py-3 font-semibold uppercase">UPDATE
                                            Loan</button>
                                    </div>
                                </div>
                            </div>
