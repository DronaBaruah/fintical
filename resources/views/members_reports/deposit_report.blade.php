            ...
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <thead>
                    ...
                    <tr height=24>
                        ...
                        <th height=24 width="35%" class="xl113 text-center" style='height:18.0pt'>Remark</th>
                ...
                <tbody>
                    ...
                    <tr height=24 class="odd">
                        ...
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>{{ $deposit->deposit_id }}
                        </td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ date('jS M Y', strtotime($deposit->date)) }}</td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>{{ $deposit->month }}</td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>{{ $deposit->remark }}</td>
                        <td class="xl123 text-right pr-4">{{ number_format((float)$deposit->amount, 2, '.', '') }}/-
                        </td>
                    </tr>
                    <?php $number ++ ?>
                    @endforeach
