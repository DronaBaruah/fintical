...
<head>
    ...
    <title>Deposit Late Fine Report</title>
</head>
        ...
        <tbody>
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <thead>
                    ...
                    <tr height=24>
                        ...
                        <th height=24 width="12%" class="xl113 text-center" style='height:18.0pt'>Month</th>
                        <th height=24 width="30%" class="xl113 text-center" style='height:18.0pt'>Remark</th>
                        <th width="18%" class="xl113 text-right pr-4">Total Late Fine Amount</th>
                    </tr>
                </thead>

                <tbody>
                    <?php $number = 1; ?>
                    @foreach ($late_fines as $late_fine)
                    <tr height=24 class="odd">
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>{{ $number }}</td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>{{ $late_fine->deposit_id }}
                        </td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>
                            {{ date('jS M Y', strtotime($late_fine->date)) }}</td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>{{ $late_fine->month }}</td>
                        <td height=24 class="xl123 text-center" style='height:18.0pt'>{{ $late_fine->remark }}</td>
                        <td class="xl123 text-right pr-4">{{ number_format((float)$late_fine->fine, 2, '.', '') }}/-
                        </td>
                    </tr>
                    <?php $number ++ ?>
                    @endforeach

                    @if($late_fines->isEmpty())
                    <tr height=24 class="odd">
            ...
            <table border=0 cellpadding=0 cellspacing=0 width=810 class="m-auto"
                ...
                <tr height=24>
                    ...
                    <td class="xl101 font-bold text-center" style='border-left:none'>Total Late Fine Amount</td>
                    <td class="xl102 font-bold">₹</td>
                    <td class="xl103 font-bold pr-4"><span
                            style='mso-spacerun:yes'> </span>{{ $total_late_fine_amount }}/-
                    </td>
                </tr>
                <tr height=24>
