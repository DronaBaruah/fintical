                ...
                <div class="md:flex w-full m-auto">
                    ...
                    <div class="w-full py-5 px-5 md:px-10">
                        <div class="text-center mb-5">
                            <h1 class="font-semibold text-xl md:text-xl text-gray-900 uppercase">Members Reports</h1>
                        </div>
                        <form method="GET" action="/members_reports/show">
                            @csrf
                            <div class="md:flex">
                                <div class="w-full md:px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Select Member</label>
                                    <div class="flex w-full">
                                        <select name="member_id" id="member_id" class="w-full" required>
