                ...
                <div class="md:flex w-full m-auto">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-xl text-gray-900 uppercase">Interest Non Payment</h1>
                        ...
                        <div class="mb-10 bg-green-100 border border-green-400 text-gray-800 px-4 py-3 rounded-md relative interestModal"
                            ...
                            <div class="text-center">{{ session()->get('transaction_id') }}
                                <span class="absolute top-0 bottom-0 right-0 md:px-4 md:pr-0 pr-2 py-3">
                        ...
                        <form method="GET" action="/interest_non_payment/create">
                            @csrf
                            <div>
                                <div class="flex -mx-3">
