                ...
                <div class="md:flex w-full m-auto">
                    ...
                    <div class="w-full py-5 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-semibold text-lg text-gray-900">INTEREST NON PAYMENT FORM</h1>
                            <p>Enter Interest non payment information</p>
                        </div>

                        <!-- Validation Errors -->
                        <x-auth-validation-errors class="mb-4" :errors="$errors" />

                        <form method="POST" action="/interest_non_payment">
                            @csrf
                            <div>
                                ...
                                <div class="md:flex -mx-3">
                                    ...
                                    <div class="w-full px-3 mb-5">
                                        <label for="" class="text-xs font-semibold px-1">Previous Interest Non
                                            Payment</label>
                                        <div class="flex">
                                            <div
                                                class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            ...
                                            <input type="number" name="pre_non_pay"
                                                value="{{ $total_interest_non_pay }}" id="pre_non_pay" step=".01"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 bg-gray-100 border-gray-200 outline-none"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="md:flex -mx-3">
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="number" name="interest_non_pay" id="interest_non_pay" min="0"
                                    ...
                                    <div class="w-full px-3 mb-5">
                                        <label for="" class="text-xs font-semibold px-1">Total Interest Non
                                            Payment</label>
                                        <div class="flex">
                                            <div
                                                class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            ...
                                            <input type="text" name="total_interest_non_pay" id="total_interest_non_pay"
                                ...
                                $("input[type=number]").on("input", function() {
                                    var total = parseFloat($("#pre_non_pay").val()) + parseFloat($(
                                            "#interest_non_pay")
                                        .val())
                                    $("#total_interest_non_pay").val(total);
                                })
                                </script>
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-1 mb-3 mt-2">
                                        <button
                                            class="block w-full max-w-xs mx-auto uppercase bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-2 py-3 font-semibold text-base">Add
