...
class MyReportController extends Controller
{
    ...
    {
        $usernew = User:: where([['id', auth()->user()->id], ['society_member', 'yes'], ['status', 'yes']])->first();
            
        if($usernew)
        {
            return view('my_reports.reports')
                ->with('society', Society::where('society_id', $usernew->society_id)->first());
        }
        else
        {
            return redirect('/dashboard')
                ->with('access_denied', 'You are not a Society Member');
        }
    }
    ...
    public function deposit_report()
    {
        ...
        if($usernew)
        {
            ...
            return view('my_reports.deposit_report', compact('total_deposit_amount', 'date'))
    ...
    public function late_fine_report()
    {
        ...
        {            
            ...
            return view('my_reports.late_fine_report', compact('total_late_fine_amount', 'date'))
                ->with('society', Society::where('society_id', $society_id)->first())
                ->with('members', User::where([['society_id', $society_id], ['id', $member_id], ['society_member', 'yes'], ['status', 'yes']])->first())
                ->with('admins', User::where([['society_id', $society_id], ['status', 'yes']])->wherehas('roles', function($q){
                    $q->where('name', 'admin');
    ...
    public function loan_report()
    {
        ...
        if($usernew)
        {
            ...
            return view('my_reports.loan_report', compact('total_loan_amount', 'date'))
                ->with('society', Society::where('society_id', $society_id)->first())
                ->with('members', User::where([['society_id', $society_id], ['id', $member_id], ['society_member', 'yes'], ['status', 'yes']])->first())
                ->with('admins', User::where([['society_id', $society_id], ['status', 'yes']])->wherehas('roles', function($q){
                    $q->where('name', 'admin');
    ...
    public function interest_report()
    {
        ...
        if($usernew)
        {
            ...
            return view('my_reports.interest_report', compact('total_interest_amount', 'date'))
                ->with('society', Society::where('society_id', $society_id)->first())
                ->with('members', User::where([['society_id', $society_id], ['id', $member_id], ['society_member', 'yes'], ['status', 'yes']])->first())
                ->with('admins', User::where([['society_id', $society_id], ['status', 'yes']])->wherehas('roles', function($q){
                    $q->where('name', 'admin');
    ...
    public function loan_repayment_report()
    {
        ...
        if($usernew)
        {
            ...
            return view('my_reports.disbursed_report', compact('total_disbursed_amount', 'date'))
                ->with('society', Society::where('society_id', $society_id)->first())
                ->with('members', User::where([['society_id', $society_id], ['id', $member_id], ['society_member', 'yes'], ['status', 'yes']])->first())
                ->with('admins', User::where([['society_id', $society_id], ['status', 'yes']])->wherehas('roles', function($q){
                    $q->where('name', 'admin');
